...
defaultproperties
{
     ...
     TauntSound(0)=Sound'TauntPack.MN_and_stay_down'
     TauntSound(1)=Sound'TauntPack.MN_anyoneelsewantsome'
     TauntSound(2)=Sound'TauntPack.MN_boom'
     TauntSound(3)=Sound'TauntPack.MN_burnbaby'
     TauntSound(4)=Sound'TauntPack.MN_diebitch'
     TauntSound(5)=Sound'TauntPack.MN_eatthat'
     TauntSound(6)=Sound'TauntPack.MN_fightlikenali'
     TauntSound(7)=Sound'TauntPack.MN_isthatyourbest'
     TauntSound(8)=Sound'TauntPack.MN_kissmyass'
     TauntSound(9)=Sound'TauntPack.MN_loser'
     TauntSound(10)=Sound'TauntPack.MN_myhouse'
     TauntSound(11)=Sound'TauntPack.MN_next'
     TauntSound(12)=Sound'TauntPack.MN_ohyeah'
     TauntSound(13)=Sound'TauntPack.MN_ownage'
     TauntSound(14)=Sound'TauntPack.MN_seeya'
     TauntSound(15)=Sound'TauntPack.MN_that_had_to_hurt'
     TauntSound(16)=Sound'TauntPack.MN_useless'
     TauntSound(17)=Sound'TauntPack.MN_you_play_like_a_girl'
     TauntSound(18)=Sound'TauntPack.MN_youbedead'
     TauntSound(19)=Sound'TauntPack.MN_youlikethat'
     TauntSound(20)=Sound'TauntPack.MN_youwhore'
     TauntSound(21)=Sound'TauntPack.MN_blowme'
     TauntSound(22)=Sound'TauntPack.MN_camper'
     TauntSound(23)=Sound'TauntPack.MN_douchebag'
     TauntSound(24)=Sound'TauntPack.MN_spammer'
     TauntSound(25)=Sound'TauntPack.MN_sucker'
     TauntSound(26)=Sound'TauntPack.MN_talktothehand'
     TauntSound(27)=Sound'TauntPack.MN_youdick'
